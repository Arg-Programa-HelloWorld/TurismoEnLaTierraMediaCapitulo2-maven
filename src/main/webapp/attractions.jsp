		...
		<div id="carouselExampleCaptions" class="carousel slide"
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item">
					<img src="images/attractions/minas_tirith.jpg" class="d-block w-100"
						alt="...">
					<div class="carousel-caption d-none d-md-block">
						<h5>Minas Tirith</h5>
				...
				<div class="carousel-item">
					<img src="images/attractions/abismo_de_helm.jpg" class="d-block w-100"
						alt="...">
					<div class="carousel-caption d-none d-md-block">
				...
				<div class="carousel-item">
					<img src="images/attractions/bosque_negro.jpg" class="d-block w-100"
						alt="...">
					<div class="carousel-caption d-none d-md-block">
						<h5>Bosque Negro</h5>
		...
		<div class="container-fluid">
			<div class="container marketing">
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<img src="images/attractions/minas_tirith.jpg" class="rounded-circle"
							alt="Cinque Terre" width="140" height="140">
					...
					<div class="col-lg-4">
						<img src="images/attractions/la_comarca.jpg" class="rounded-circle"
							alt="Cinque Terre" width="140" height="140">
					...
					<div class="col-lg-4">
						<img src="images/attractions/abismo_de_helm.jpg" class="rounded-circle"
							alt="Cinque Terre" width="140" height="140">
					...
					<div class="col-lg-4">
						<img src="images/attractions/lothlorien.jpg" class="rounded-circle"
							alt="Cinque Terre" width="140" height="140">
					...
					<div class="col-lg-4">
						<img src="images/attractions/bosque_negro.jpg" class="rounded-circle"
							alt="Cinque Terre" width="140" height="140">
					...
					<div class="col-lg-4">
						<img src="images/attractions/paso_de_caradhras.jpg" class="rounded-circle"
							alt="Cinque Terre" width="140" height="140">
