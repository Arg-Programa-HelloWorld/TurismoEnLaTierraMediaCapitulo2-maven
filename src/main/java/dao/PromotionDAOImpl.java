...
public class PromotionDAOImpl implements PromotionDAO {
	...
	private Promotion toPromotion(ResultSet results) throws SQLException {
		...
		if (result == 2) {
			...
			// Promotion( Integer id, String name, Double time, Double cost, Double discount
			// int fk_id_promotion_type PromotionType promotion_type.name)
			promotionTempAbsolute = new PromotionAbsolute(results.getInt(1), results.getString(2), results.getDouble(3),
		 ...
		 * LinkedList<Attraction> attractionListPercentage;
		 * 
		 * attractionListPercentage = (LinkedList<Attraction>)
		 * attractionDAO.searchAttractionsOfAPromotionByID(results.getInt(1));
		 * 
		 * 
		 ...
		 * promotionTempPercentage = new PromotionPercentage(results.getInt(1),
		 * results.getString(2),results.getDouble(3),results.getDouble(4),results.
		 * getDouble(5),results.getInt(6),PromotionType.valueOf(results.getString(7)),
		 * attractionListPercentage);
		 * 
		 * promotionTempPercentage.calculatePrice();
		 * 
		 ...
		 * LinkedList<Attraction> attractionListAbsolute;
		 * 
		 * attractionListAbsolute = (LinkedList<Attraction>)
		 * attractionDAO.searchAttractionsOfAPromotionByID(results.getInt(1));
		 * 
		 * //Promotion( Integer id, String name, Double time, Double cost, Double
		 * discount int fk_id_promotion_type PromotionType promotion_type.name)
		 * promotionTempAbsolute = new PromotionAbsolute(results.getInt(1),
		 * results.getString(2),results.getDouble(3),results.getDouble(4),results.
		 * getDouble(5),results.getInt(6),PromotionType.valueOf(results.getString(7)),
		 * attractionListAbsolute);
		 * 
		 * promotionTempAbsolute.calculatePrice();
		 * 
		 * //update(promotionTemp);
		 ...
		 * LinkedList<Attraction> attractionListAyB;
		 * 
		 * attractionListAyB = (LinkedList<Attraction>)
		 * attractionDAO.searchAttractionsOfAPromotionByID(results.getInt(1));
		 * 
		 * //Promotion( Integer id, String name, Double time, Double cost, Double
		 * discount int fk_id_promotion_type PromotionType promotion_type.name)
		 * promotionTempAyB = new PromotionAyB(results.getInt(1),
		 * results.getString(2),results.getDouble(3),results.getDouble(4),results.
		 * getDouble(5),results.getInt(6),PromotionType.valueOf(results.getString(7)),
		 * attractionListAyB);
		 * 
