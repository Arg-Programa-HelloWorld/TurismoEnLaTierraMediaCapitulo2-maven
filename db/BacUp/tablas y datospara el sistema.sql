...
INSERT INTO 'users' (id, name, budget, time, fk_id_preference) VALUES (1,'Eowyn-Normal',10.0,7.25,1),
(2,'Eowyn-2-AtracNoBudget',13.0,9.0,1),
(3,'Eowyn-2-AtracNoTime',48.0,8.0,1),
(4,'Eowyn-PromotionNoBudget',9.0,10.0,1),
(5,'Gandalf',100.0,5.0,2),
(6,'Sam',36.0,8.0,3),
(7,'Galadriel',120.0,6.0,2),
(8,'Frodo',15.0,4.0,3),
(9,'Meriadoc',25.0,8.0,3),
(10,'Peregrin',40.0,12.0,1),
(11,'Boromir',10.0,9.0,3),
(12,'Legolas',26.0,4.0,2),
(13,'Gimli',38.0,12.0,2),
(14,'Roberto',100.0,100.0,2);
